 ...
 */
export type ListReducer<T extends Key> = (accum: Event<T>, events: Immutable.List<Event<T>>) => Event<T>;
/**
 ...
 */
export type KeyedCollectionCallback<T extends Key> = (collection: Collection<T>, key: string) => void;
/**
